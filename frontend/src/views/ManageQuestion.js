    ...
    return (
        <div style={{ marginTop: '116px', marginLeft: "200px", display: 'flex', backgroundColor: "#C3B091" }}>
            <div className="col-md-4 col-xl-3" style={{ margin: "50px" }}>
                <Link className="nav-link" to="/CreateQuestion" style={linkStyle}>
                    <div 
                    ...
                    >
                        <div className="card-block">
                            <h4 className="m-b-20">Add Question</h4>
            ...
            <div className="col-md-4 col-xl-3" style={{ margin: "50px" }}>
                <Link className="nav-link" to="/ViewQuestion" style={linkStyle}>
                    <div 
                        className="card bg-c-green order-card" 
                        style={{
                            ...cardStyle,
                    ...
                    >
                        <div className="card-block">
                            <h4 className="m-b-20">View Questions</h4>
